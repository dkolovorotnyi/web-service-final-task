...
class UserManagementWithMocks extends BaseRestTest {
    ...
    void getUserDetailsWithPaymentAndAddress(UserDetails userDetails) {
        final ResponseDefinitionBuilder addressBuilder = new ResponseDefinitionBuilder();
        ...
        final ResponseDefinitionBuilder paymentBuilder = new ResponseDefinitionBuilder();
